...
The baseline track selection shared by the primary vertex fit, the V0 finder and the secondary vertex finders requires `chi2/ndf <= 10`, finite positive d0, phi and z0 perigee variances and at least `kTrackMinTPCHits` (4) TPC hits; `--noTPCHitCut` (data and MC) drops the TPC hit requirement.
